...
public class CategoryAdminPost extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener {
    private ArrayList<ShopRegisterFetch> courseModelArrayList;
    private RecyclerView courseRV;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_category_admin_post);
        courseRV = findViewById(R.id.adminDashCardsCategory);
        getShopList();
        setupRecyclerView();
    }
    private void getShopList() {
        ...
        MySharedPreferences sharedPreferences = MySharedPreferences.getInstance(CategoryAdminPost.this);
        String email = sharedPreferences.getString("email", "Default");
        apiService.getCategoryShopList(email).enqueue(new Callback<List<Object>>() {
            @Override
            public void onResponse(Call<List<Object>> call, Response<List<Object>> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(CategoryAdminPost.this, "Failed to fetch categories" + response.message(), Toast.LENGTH_SHORT).show();
                }
            }
            @Override
            public void onFailure(Call<List<Object>> call, Throwable t) {
                t.printStackTrace();
                if (CategoryAdminPost.this != null) {
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(CategoryAdminPost.this, DynamicStoreCard.class);
